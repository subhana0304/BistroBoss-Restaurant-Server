...
const uri = `mongodb://${process.env.DB_USER}:${process.env.DB_PASSWORD}@ac-4z5ldfg-shard-00-00.zmsfvx2.mongodb.net:27017,ac-4z5ldfg-shard-00-01.zmsfvx2.mongodb.net:27017,ac-4z5ldfg-shard-00-02.zmsfvx2.mongodb.net:27017/?ssl=true&replicaSet=atlas-xqbf6l-shard-0&authSource=admin&retryWrites=true&w=majority`
...
app.get('/', (req, res) =>{
    res.send('Boss is sitting Up')
});

app.listen(port, ()=>{
    console.log(`bistro boss is sitting up on port ${port}`);
});